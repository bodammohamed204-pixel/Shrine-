...
function featureGraphicSvg() {
  ...
  <svg width="1024" height="500" viewBox="0 0 1024 500" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="92" y="196" font-family="Arial, sans-serif" font-size="82" font-weight="700" fill="#147BC5">Shrine</text>
    <text x="96" y="268" font-family="Arial, sans-serif" font-size="34" fill="#253040">Create, search, and preserve memorials</text>
    <text x="96" y="326" font-family="Arial, sans-serif" font-size="28" fill="#5D6875">Private account setup with WhatsApp OTP</text>
  </svg>`;
}
...
await pngFromSvg(featureGraphicSvg(), path.join(storeDir, "feature-graphic-1024x500.png"), 1024, 500);
...
await pngFromSvg(featureGraphicSvg(), path.join(capacitorAssetDir, "splash.png"), 2732, 2732);
